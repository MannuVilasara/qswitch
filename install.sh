...
# Function for simple flavor selection
select_flavors() {
...
# Check if we're already in the qswitch directory
...
# Call simple selection
select_flavors

# Install selected flavours
